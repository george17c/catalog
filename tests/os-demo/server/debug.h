/*
 * Copyright (c) 2011, Razvan Deaconescu, razvan.deaconescu@cs.pub.ro
 *
 * debugging macros
...
#ifndef TESTS_OS_DEMO_SERVER_DEBUG_H_
#define TESTS_OS_DEMO_SERVER_DEBUG_H_      1
...
#endif  // TESTS_OS_DEMO_SERVER_DEBUG_H_
